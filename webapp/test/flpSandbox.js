			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zrulesmap-display": {
								"semanticObject": "zrulesmap",
								"action": "display",
								"description": "ServESS Rules Mapping",
								"title": "ServESS Rules Mapping",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zrulesmapg",
									"url": sap.ui.require.toUrl("zrulesmap")
								}
							}
						}
					}
